...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Haliuk Möbelbau | Möbel- & Küchenmontage" },
      {
        name: "description",
        content:
          "Professionelle Möbelmontage, Küchenmontage, Umzugsservice und Reparaturen für Privat- und Geschäftskunden in Deutschland.",
      },
      { name: "author", content: "Haliuk Möbelbau" },
      { name: "theme-color", content: "#0f2b50" },
      { property: "og:site_name", content: "Haliuk Möbelbau" },
